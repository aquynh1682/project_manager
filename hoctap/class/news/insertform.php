...
<body>
    ...
    <div class="main">
        ...
        <div class="center">
            ...
            <h1 style="font-family: cursive;color: brown;text-align: center;">Thêm tin tức mới</h1>
            <section>
                <main>
                    <form action="insertaction.php" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><textarea name="description" id="" cols="30" rows="10"></textarea><br></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td> <input type="author" name="author"></td>
                            </tr>
